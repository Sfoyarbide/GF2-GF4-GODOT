...
public partial class DefenseUP : ModifierStatsInflict
{
    public DefenseUP()
    {
        InflictStateType = InflictStates.DefendUP;
        OpposedModifierStatsInflictType = InflictStates.DefendDOWN;
    ...
    {
        character.DataContainer.DefenseModifier = 1f;
    }
